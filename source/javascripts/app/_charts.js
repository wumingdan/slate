...
(function() {
    var h = {},
        mt = {},
        c = {
            id: "eb8e497b3383518a5c42758a16b4007f",
            dm: ["lovelandy.me", "q.hm.baidu.com"],
    ...
    (mt.p.T = function() {
        ...
        (function() {
            if (!f)
                if (f = q, "complete" === document.readyState) a.D = q;
                else if (document.addEventListener) document.addEventListener("DOMContentLoaded",
                b, w), window.addEventListener("load", a, w);
            ...
            f = {
                init: function() {
                    if ("" !== c.icon) {
                        ...
                        d = c.icon.split("|");
                        var b = a.Ma + "?s=" + c.id,
                            f = ("http:" == a.protocol ? "http://eiv" : "https://bs") + ".baidu.com" + d[0] + "." + d[1];
                        switch (d[1]) {
                            case "swf":
            ...
            f = {
                ...
                ua: function() {
                    return function(a) {
                        ...
                        if (b) {
                            var e = b.getAttribute("HM_fix"),
                                f = a.clientX + ":" + a.clientY;
                            if (e && e ==
                                f) b.removeAttribute("HM_fix");
    ...
    (function() {
        ...
        function e() {
            ...
            if ((!m || !k) && g && n) u = q, s = +new Date;
            else if (m && k && (!g || !n)) u = w, t += +new Date - s;
            m = g;
            k = n;
            B = setTimeout(e, 100)
        }
        ...
        function f(a) {
            ...
            if (a in k) b = a;
                ...
                for (var s = ["webkit", "ms", "moz", "o"], d = 0; d < s.length; d++) {
    ...
    (function() {
        ...
        var f = mt.lang,
            ...
            g = {
                ...
                wa: function() {
                    if (0 < g.A.length)
                        for (var a = 0, b = g.A.length; a < b; a++) g.R(g.A[a]);
                    g.A = r
                },
                R: function(a) {
                    var b = a[0];
                ...
                _trackRTEvent: function(e) {
                    ...
                    if (f.d(e, "Object")) {
                        ...
                        if (900 >= m) l.call(this, e);
                            ...
                            for (var m = Math.ceil(m / 900), s = "block|" + Math.round(Math.random() *
        ...
        a.prototype = {
            ...
            ma: function() {
                var a = document.location.hash.substring(1),
                    b = RegExp(c.id),
                    d = -1 < document.referrer.indexOf(n.ka),
                    f = e.l(a, "jn"),
                ...
                v = function(a, f) {
                    ...
                    if (f) {
                        var k = f.getAttribute("href"),
                            l = f.getAttribute("onclick") ? "" + f.getAttribute("onclick") : r,
                            n = f.getAttribute("id") || "";
                ...
                var u = function(a, b) {
                    ...
                    if (e.d(b, "Array") || e.d(b, "NodeList"))
                        for (var d = 0, f = b.length; d < f; d++)
                            if (t === b[d]) return v(l + a + "/" + (d + 1), b[d]), w
                };
